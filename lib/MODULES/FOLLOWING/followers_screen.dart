...
class _FollowersScreenState extends State<FollowersScreen> {
  ...
  void initState() {
    ...
    BlocProvider.of<FetchBloc<GFollowers>>(context)
        .add(List_Refresh_Event<GFollowers>());

    BlocProvider.of<FetchBloc<GFollowers>>(context).add(
        List_Fetch_Event<GFollowers>((counter) => FollowAccountRepo.instance
            .fetchProp_myFollowers(
  ...
  AppBar myHeader() {
    return AppBar(
      ...
      title: const Text(
        'My followers', //give here appBar title
