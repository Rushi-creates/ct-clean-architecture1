          ...
          children: [
            ...
            ChipWidget<GMyPostsChips>(
                ...
                activeWidget: singleButton(context,
                    ...
                    color1: const Color(0xff96D1FF),
                    color2: const Color.fromARGB(255, 51, 154, 233),
                    boxShadowColor: const Color(0xff96D1FF).withOpacity(0.4),
                    iconPath: ImagePaths.seriesChipIcon),
                ...
                nonActiveWidget: singleButton(context,
                    ...
                    color2: const Color.fromARGB(255, 250, 250, 250),
                    boxShadowColor: Colors.transparent,
                    iconPath: ImagePaths.seriesChipIconBlack)),
