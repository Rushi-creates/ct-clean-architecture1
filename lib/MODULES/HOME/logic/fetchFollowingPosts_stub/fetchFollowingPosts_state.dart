...
abstract class FetchFollowingPostsState<T> extends Equatable {
  final List fetchFollowingPostsList;
  const FetchFollowingPostsState({required this.fetchFollowingPostsList});
  @override
  List<Object> get props => [fetchFollowingPostsList];
}
...
class FetchFollowingPostsList_Error_State<T>
  ...
  const FetchFollowingPostsList_Error_State(
      {required this.fetchFollowingPostsList, required this.error})
      : super(fetchFollowingPostsList: fetchFollowingPostsList);
}
